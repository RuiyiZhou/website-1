    ...
    <?php include('float_navigation.php'); ?>
      ...
      <div class="margintop100">
        <div class="container">
          ...
          <div class="quote">
            <blockquote>How can we use visualization to help global travelers evaluate destination?</blockquote>
          </div>
          ...
          <div class="row margintop50">
            <div class="col-md-7" style="float: none; margin: 0 auto; text-align: center">
              TraveLENS is an interactive visualization tool that equips potential travellers with data and information across a wide range of risk factors that could influence in their decision-making process. It is designed to let the users see and explore the world
              through different categories of lenses depending on their tasks and goals, and the visualization is designed to adapt and morph to fit the requirements of each category and to present that category’s information in the most effective and
              expressive way.
            </div>
          </div>
