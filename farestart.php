...
<li>Provide relevant info for each of the specific audiences (students, catering customers, donors, etc) to fulfill their needs. Success will be measured by improved <b>task efficiency and reduced error rate</b></li>
           ...
           <p><b>Rationale</b></p>
<p>The FareStart website is a resource for a variety of audiences with independent needs. The current website, designed seven years ago, lacks a few important features including a responsive/mobile-friendly design.</p> <p>Additionally, content is not always easily discoverable and visitors may be abandoning the site prior to finding the information they were seeking.
In order to accurately reflect all that FareStart offers and to continue to grow the FareStart community, a site redesign focused on rearchitecting content based on specific user needs is recommended.</p>
            </div>
        </div>
...
<p>We listed out all the features the current site offered and use <b>Optimal Workshop</b> to have participants do <b>open-end card sorting</b> - grouping these features according to their personal understanding. Then based on this card sorting results we formed a new information architecture.</p>
