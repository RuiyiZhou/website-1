        ...
        <div class="container">
              ...
              <ul class="tablerow">
                <li class="tablecell">
                  <p>To gain a more user centered understand of our original design question, our team used surveys, interviews, field investigation, historical analysis and competitive product surveys to better inform the development of a viable prototype
                    for rooftop hydroponic gardens that can be controlled with mobile applications.</p>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row featurette marginbottomtop30">
            ...
            <div class="col-md-6 vcenter">
              <a class="example-image-link" href="images/smartponics-survey.png" data-lightbox="example-1"><img class="example-image img-responsive" src="images/smartponics-survey.png" alt="image-1" style="max-width: 100%; margin:0 auto" /></a>
            </div>
          </div>
          ...
          <div class="row featurette marginbottomtop30">
            <div class="col-md-5 vcenter">
              ...
              <p>We visited the Cascade P-Patch in South Lake Union and the UW Farm to gather photos of plot organization and amenities. For the hydroponic investigation we visited the indoor Sun Shoppe in Fremont multiple times to confirm our design idea
                to the realities and requirements of hydroponic gardening. </p>
            </div>
            <div class="col-md-6 vcenter">
              <a class="example-image-link" href="images/smartponics_fieldinvestigation.jpg" data-lightbox="example-1"><img class="example-image img-responsive" src="images/smartponics_fieldinvestigation.jpg" alt="image-1" style="max-width: 100%; margin:0 auto" /></a>
          ...
          <div class="row featurette marginbottomtop30">
            <div class="col-md-5 vcenter">
              ...
              <p>From our previous interview with Shaun Murphy at the Indoor Sun Shoppe, we were told of potential competitor equipment. They are: the iPonic controller from Link4 and IntelliDose Nutrient & Ph controller from American Hydroponics. The Link4
                iPonic controller focuses on the commercial market rather than individual/home markets, while IntelliDose has already began to expand their market from commercial market to individual large scale operations.</p>
            </div>
            <div class="col-md-6 vcenter">
              <a class="example-image-link" href="images/smarponics_competitiveanalysis.png" data-lightbox="example-1"><img class="example-image img-responsive" src="images/smarponics_competitiveanalysis.png" alt="image-1" style="max-width: 100%; margin:0 auto" /></a>
    ...
    <li>
      <a href="#slide3"><img style="max-width: 100%; margin: 0 auto" src="images/smartponics_persona_3.png"></a>
          ...
          <div class="row featurette">
            <div class="col-md-5">
              <p>This study intended to determine how effectively the SmartPonics application’s design could guide users through the application and hardware setup process, check supply levels and manipulate settings. We conducted user testing between Nov
                17 – Nov 19.</p>
